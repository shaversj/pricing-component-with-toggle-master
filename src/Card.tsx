  ...
  return (
    <>
      ...
      >
        <h3
          data-position={product.id.toString()}
          className={"text-center text-[18px] font-bold leading-[28px] text-neutral-grayish-blue data-[position='2']:text-white"}
        >
          {product.name}
        </h3>
        <div
          data-position={product.id.toString()}
          className={"flex items-center justify-center gap-x-[7.46px] pt-6 font-bold text-neutral-dark-grayish-blue data-[position='2']:text-white"}
        >
        ...
        <div className={"mx-[29px] pt-8"}>
          <div
            data-position={product.id.toString()}
            className={
              "flex flex-col divide-y-[1px] divide-neutral-grayish-line-color border-b-[1px] border-t-[1px] border-neutral-grayish-line-color font-semibold leading-none text-neutral-grayish-blue data-[position='2']:text-white"
            }
          >
            {product.features.map((feature, index) => (
              <span key={index} className={"py-3 text-center text-[15px] font-bold leading-[28px]"}>
                {feature}
              </span>
            ))}
          </div>
